...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactWebpackRails = __webpack_require__(2);

	var _reactWebpackRails2 = _interopRequireDefault(_reactWebpackRails);

	var _helloWorld = __webpack_require__(168);

	var _helloWorld2 = _interopRequireDefault(_helloWorld);

	var _pages = __webpack_require__(169);

	var _pages2 = _interopRequireDefault(_pages);

	var _page = __webpack_require__(170);

	var _page2 = _interopRequireDefault(_page);

	var _welcome = __webpack_require__(171);
	...
	var _headerzal = __webpack_require__(173);

	var _headerzal2 = _interopRequireDefault(_headerzal);
	...
	_reactWebpackRails2.default.run();

	_reactWebpackRails2.default.registerComponent('HelloWorld', _helloWorld2.default);

	_reactWebpackRails2.default.registerComponent('Pages', _pages2.default);

	_reactWebpackRails2.default.registerComponent('Page', _page2.default);

	_reactWebpackRails2.default.registerComponent('Welcome', _welcome2.default);

	_reactWebpackRails2.default.registerComponent('Header', _header2.default);

	_reactWebpackRails2.default.registerComponent('HeaderZal', _headerzal2.default);

	_reactWebpackRails2.default.registerComponent('Footer', _footer2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.reactRouter = exports.env = exports.integrationsManager = exports.nodes = exports.react = undefined;
	...
	var _integrationsManager = __webpack_require__(5);
	...
	var _version = __webpack_require__(167);
	...
	var RWR = function () {
	  function RWR() {
	    ...
	    this.renderRouter = _reactRouter2.default.renderRouter;
	    this.registerRouter = _reactRouter2.default.registerRouter;
	    this.unmountRouter = _reactRouter2.default.unmountRouter;
	    this.getRouter = _reactRouter2.default.getRouter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ELEMENT_ATTR = 'data-react-element';
	...
	var IntegrationsManager = function () {
	  function IntegrationsManager() {
	    ...
	    this.integrations = {
	      ...
	      'react-router': _reactRouter2.default.integrationWrapper
	    };
	  }
	...
	var Pages = function (_React$Component) {
	  ...
	  _createClass(Pages, [{
	    ...
	    value: function render() {
	      ...
	      console.log(pages);
	      var map = pages.map(function (object, i) {
	        return _react2.default.createElement(_page2.default, { key: i, obj: object });
	      });
	      return _react2.default.createElement(
	        'div',
	        null,
	...
	var Page = function (_React$Component) {
	  ...
	  _createClass(Page, [{
	    ...
	    value: function render() {
	      ...
	      var content = this.props.obj.content;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { onClick: this.remove.bind(this), id: Date.now(), href: '/pages/' + id, 'data-method': 'delete', 'data-remote': 'true' },
	            ' Delete'
	          )
	        )
	      );
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"div",
								{ className: "col-md-12 bgpicture" },
								_react2.default.createElement(
									"div",
									{ className: "text-center napis" },
									_react2.default.createElement(
										"h1",
										null,
										"GlarStar Company"
									...
									_react2.default.createElement(
										"p",
										null,
										"Chcesz zrobić sobie bloga? No to dawej synu!"
									),
									_react2.default.createElement(
										"a",
										{ className: "btn btn-primary btn-lg", href: "users/sign_up" },
										"Sign up!"
									)
								)
							)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement("img", { src: "http://placehold.it/150x50&text=Logo", alt: "gfg" })
							)
						),
						_react2.default.createElement(
							"div",
							{ className: "collapse navbar-collapse navbar-right", id: "bs-example-navbar-collapse-1" },
							_react2.default.createElement(
								"ul",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderZal = function (_React$Component) {
		_inherits(HeaderZal, _React$Component);

		function HeaderZal() {
			_classCallCheck(this, HeaderZal);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(HeaderZal).apply(this, arguments));
		}

		_createClass(HeaderZal, [{
			key: "render",
			value: function render() {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"p",
								null,
								"Copyright © GlarStar Company 2016 "
							)
						)
					)
				);
